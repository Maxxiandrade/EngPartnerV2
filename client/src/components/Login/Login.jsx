  ...
  return (
    ...
    <>
        ...
        <div className={style.container}>
          ...
          <div className={style.formContainer}>
            <form onSubmit={signInWithEmail} className={style.form}>
              <label htmlFor="email" className={style.inputSize}>Email</label>
              <input type="text" name="email" id="email" className={style.input} />
              <br />
              <label htmlFor="password" className={style.inputSize}>Password</label>
      ...
      <footer className={style.about}>
        <p>Developed by: Andrade Maximiliano, Britos Gaspar, D'lppolito Luciano, Ford Vicente, Martinez Jose, Reyes Luis.</p>
      </footer>
    </>
  );
};
